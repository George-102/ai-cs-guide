...
- *Physically Based Rendering (PBRT)* — The authoritative text on offline rendering and path tracing, free online

**Courses**

- [UC Berkeley CS184: Introduction to Computer Graphics](https://inst.eecs.berkeley.edu/~cs184/) — Berkeley's graphics course with complete project assignments
- [Stanford CS148: Introduction to Computer Graphics](https://cs148.stanford.edu/) — Stanford's introductory graphics course
- [6.837 (MIT)](https://ocw.mit.edu/courses/6-837-computer-graphics-fall-2012/) — MIT's computer graphics course

**Hands-on Tutorials (Highly Recommended)**

- [LearnOpenGL](https://learnopengl.com/) — The best OpenGL tutorial, available in Chinese, build a rendering pipeline from scratch
- [Ray Tracing in One Weekend](https://raytracing.github.io/) — Build a ray tracer in three days, free online, best starting project
