...
- [MIT 6.031: Software Construction](https://web.mit.edu/6.031/www/sp21/) — Highly recommended. 30 readings covering static checking, testing, specifications, ADTs, concurrency, version control, and other core topics, each with exercises. Based on Java, but the concepts apply to all languages.
- [Berkeley CS169: Software Engineering](https://cs169.org/) — Berkeley's software engineering course, focusing on agile development and SaaS architecture
- [CMU 17-313: Foundations of Software Engineering](https://cmu-313.github.io/) — CMU's software engineering foundations course
...
- *Software Engineering: A Practitioner's Approach* (Pressman) — Comprehensive software engineering textbook
